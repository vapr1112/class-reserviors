...
public:
	...
	reservoir(const reservoir& reservoir_p);//конструктор копировани€
	...
	void comp_type(reservoir reservoir_p) const//провер€ет, относ€тс€ ли водоемы к одному типу
	{
		strcmp(type, reservoir_p.type) == 0 ? cout << "\nводоемы относ€тс€ к одному типу\n": cout << "\nводоемы относ€тс€ к разным типам\n";
	}
